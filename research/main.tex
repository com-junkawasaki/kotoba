...
\begin{definition}[DPO Production]
...
\begin{definition}[Process Network Graph]
...
\begin{theorem}[Topological Execution Ordering]
...
\begin{lemma}[Execution Parallelism]
...
\begin{theorem}[Pattern Matching Complexity]
...
\begin{theorem}[Topological Sort Complexity]
...
\begin{theorem}[Graph Rewriting Complexity]
...
\begin{theorem}[Termination Property]
...
\begin{theorem}[Consistency Preservation]
...
\begin{definition}[Declarative-Imperative Bridge]
...
\begin{theorem}[Expressiveness Equivalence]
...
\begin{theorem}[Theoretical Superiority]
...
\begin{theorem}[Paradigm Unification Theorem]
...
\begin{corollary}[Expressiveness Hierarchy]
\[
