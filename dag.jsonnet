{
  ...
  nodes: {
    ...
    'frontend_framework': {
      ...
      type: 'frontend',
      description: 'App Routerフレームワークのコア実装',
      dependencies: ['types', 'frontend_component_ir', 'frontend_route_ir', 'frontend_render_ir', 'frontend_build_ir'],
      provides: ['AppRouter', 'ComponentRenderer', 'BuildEngine'],
      status: 'completed',
      build_order: 5,
    },
    ...
    'lib': {
      ...
      dependencies: ['types', 'ir_catalog', 'ir_rule', 'ir_query', 'ir_patch', 'ir_strategy', 'graph_core', 'storage_mvcc', 'storage_merkle', 'storage_lsm', 'planner_logical', 'planner_physical', 'planner_optimizer', 'execution_parser', 'execution_engine', 'rewrite_matcher', 'rewrite_applier', 'rewrite_engine', 'http_ir', 'http_parser', 'http_handlers', 'http_engine', 'http_server'],
      provides: ['kotoba'],
      status: 'completed',
      build_order: 11,
    },
